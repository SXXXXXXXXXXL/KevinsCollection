...
<body>
  ...
  <div class="dropdown-menu bg-secondary" aria-labelledby="contactsDropdown">
    <a class="dropdown-item" href="mailto:hildanekevin16@gmail.com">E-mail</a>
    <a class="dropdown-item" href="https://wa.me/6281290206155">Whatsapp</a>
  </div>
</li>
      </ul>
      <ul class="navbar-nav mb-2 mb-lg-0 fs-3 p-2">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" style="font-size: 20px;">Total Price : <?php total_cart_price(); ?></a>
        </li>
      </ul> 
...
// Check if a category or brand is selected
if(!isset($_GET['category']) && !isset($_GET['brand'])) {
    $select_query = "SELECT * FROM products WHERE (available_until IS NULL OR available_until < NOW()) ORDER BY RAND() LIMIT 6";
