...
if(isset($_POST['insert_cat'])){
  ...
  if($result){
    echo "<script>alert('Category Has Successfully Added')</script>";
    }
  }
}
?>
...
<div class="input-group w-10 mb-2 m-auto">
  <input type="submit" class="bg-dark text-light border-0 my-3 p-2" name="insert_cat" value="Insert Categories">
</div>
</form>